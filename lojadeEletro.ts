...
class Produto {
  ...
  setProduto(): void{
        ...
        let nomeprodUpdate = reader.question("Qual o nome do produto? ")
...
class Venda {
    ...
    constructor(produto: Produto, idVenda: number, quantidade: number, valorTotal: number, data: string){
    ...
    setVenda(): void{
        ...
        let dataUpdate = reader.question("Quando foi feita a compra? ")
...
let produto = new Produto(1, "Miojo sabor churrasco", "Piracanjuba", 7.00, 32, 1.50)
let venda = new Venda(produto, 1, 3, 21.00, '20/03/2022')
